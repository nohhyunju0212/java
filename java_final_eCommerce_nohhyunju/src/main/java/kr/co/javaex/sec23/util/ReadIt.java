...
public class ReadIt {
    ...
    static File json = new File("src/main/java/kr/co/javaex/sec23/repository/categories.json");
    static File jsonp = new File("src/main/java/kr/co/javaex/sec23/repository/products.json");
    //상대 경로 작성법을 gpt에게서 학습
    ...
    public void savepro(List<Product> list){
        try{
            mapper.writeValue(jsonp, list);
        }catch (Exception e){
            System.out.println("savepro 쪽에서 문제 발생");
        }
    }
